...
# 60 "C:/Program Files (x86)/CodeBlocks/MinGW/include/stdlib.h" 3
extern "C" {
...
# 549 "C:/Program Files (x86)/CodeBlocks/MinGW/include/stdlib.h" 3
}
# 3 "binaryTree.c" 2
...
int main()
{
    ...
    bt3.data = 3; bt3.t_left = &bt6; bt3.t_right = __null;
    bt4.data = 4; bt4.t_left = __null; bt4.t_right = __null;
    bt5.data = 5; bt5.t_left = __null; bt5.t_right = __null;
    bt6.data = 6; bt6.t_left = __null; bt6.t_right = __null;
...
void levelOrderTraverse(b_tree *bt)
{
    ...
    while(!queueEmpty(&q))
    {
        ...
        btt = queue_pop(&q);
        printf("%d ", btt->data);
        if(btt->t_left!=__null)
        {
            queue_push(&q, btt->t_left);
        }
        if(btt->t_right!=__null)
        {
